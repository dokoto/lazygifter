...
class Lazygitfter {
    ...
    _handleRequest(chat_id, items, searchInformation) {
        console.log('[LAZYGIFTER] Found %d images for query: "%s" time: %s total results: %s chadId: %s', Object.keys(items).length, decodeURI(this.query.params.q), searchInformation.formattedSearchTime, searchInformation.formattedTotalResults, chat_id);
